...
// Método para guardar un follow de un usuarios
export const saveFollow = async (req, res) => {
  try {
    ...
    // Verificar si contiene al usuario autenticado
    ...
    // Valdiar si el usuario está intentando seguirse a sí mismo
    ...
    // Validar si usuario a seguir existe
    ...
    // Validar si ya existe un seguimiento con los mismos usuarios
