...
// Test del controlador publication
...
export const showPublication = async (req, res) => {
  try {
    // ID de la publicación desde la url (parámetros)
...
// Listar publicaciones de un usuario en particular, enviándole el id del usuario en los parámetros de la URL de la petición (endpoint)
...
export const showMedia = async (req, res) => {
  try {
    ...
    // Buscar la publicación en la BD
...
export const feed = async (req, res) => {
  try {
    ...
    // Array de IDs de los usuarios que sigue el usuario autenticado
